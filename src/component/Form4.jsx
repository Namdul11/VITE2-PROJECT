...
            return <div key={i}><input type="radio" id={item.value} value={item.value} checked={currency===item.value} onChange={(e)=>{setCurrency(e.target.value)}} />
        <label htmlFor={item.value}>{item.label}</label></div>
             })}
    </div>
    <div>
        <label htmlFor="language">Language :</label>
            <select name="" id="language" value={language} onChange={(e)=>{setLanguage(e.target.value)}}>
